## Configuration
Configuration instructions can be found in configuration file [config.txt](https://github.com/uDEVOPS2020/Tool-PoC/blob/main/uTest/clientCommands/initFiles/config.txt).
